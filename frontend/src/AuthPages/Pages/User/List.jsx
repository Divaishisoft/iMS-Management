...
export default function UserList() {
    ...
    const [list, setList] = React.useState([
        { _id: '69585254472894d26666', name: 'John Doe', phone: '9875462130', email: 'johndoe@test.com', role: 'Operator' },
        { _id: '69585254472894d25625', name: 'Sam Torrent', phone: '9875462478', email: 'samtorrent@test.com', role: 'Accountant' },
    ]);
    ...
    React.useEffect(() => {
        const filteredList = list.filter(item => {
          const name = item?.name?.toLowerCase()?.includes(searchInput?.toLowerCase());
          const email = item?.email?.toLowerCase()?.includes(searchInput?.toLowerCase());
          const role = item?.role?.toLowerCase()?.includes(searchInput?.toLowerCase());
            ...
            <>
                ...
                >
                    <MenuItem onClick={() => {
                        ...
                        setTimeout(() => {
                            navigate(`/admin/user-detail/${params.row._id}`);
                        }, 500);
                    }}>
                        Detail
                    </MenuItem>
                    <MenuItem onClick={() => {
                        handleTableMenuClose();
                        setTimeout(() => {
                            navigate(`/admin/user-edit/${params.row._id}`);
                        }, 500);
                    }}>
                        Edit
                    </MenuItem>
