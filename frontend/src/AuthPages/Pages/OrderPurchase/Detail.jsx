                                    ...
                                    <tbody>
                                        {
                                            data?.items?.map((val,key)=>(
                                                <tr key={key}>
                                                    ...
                                                    <td>{val?.discountPercent ? val?.discountPercent : 0}%</td>
                                                    <td>{val?.discountRupee ? val?.discountRupee : 0}/-</td>
                                                    <td>{val?.cgst ? val?.cgst : 0}%</td>
                                                    <td>{val?.sgst ? val?.sgst : 0}%</td>
                                                    <td>{val?.igst ? val?.igst : 0}%</td>
                                                    <td>{val?.price}/-</td>
                                                    <td>{val?.subTotal}/-</td>
                                                </tr>
                                            ))
                                        ...
                                        <tr>
                                            <td colSpan={14} style={{ textAlign: 'right' }}>Total Discount</td>
                                            <td>{data?.totalDiscountRupees}/-</td>
                                        </tr>
                                        <tr>
                                            <td colSpan={14} style={{ textAlign: 'right' }}>Grand Total</td>
